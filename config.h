...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_text,  col_base,  col_blue },
	[SchemeSel]  = { col_peach, col_base,  col_teal },
};
...
/* commands */
static const char *drun[] = { "rofi", "-show", "drun", "-theme", "~/.config/rofi/drun.rasi", NULL };
static const char *terminal[] = { "kitty", NULL };

static const Key keys[] = {
	/* modifier                     key         function        argument */
    { MODKEY,                       XK_p,       spawn,          { .v = drun } },
